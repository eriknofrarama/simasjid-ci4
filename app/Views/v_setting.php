<div class="col-md-12">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <select name="id_kota" class="form-control select2">
                <?php foreach ($kota as $key => $kota) { ?>
                    <option value="<?= $kota['id'] ?>" <?= $kota['id'] == $setting['id_kota'] ? 'selected' : '' ?>>
                        <?= $kota['lokasi'] ?>
                    </option>
                <?php } ?>
        ...
        <div class="form-group">
            ...
            <select name="tahunaktif" class="form-control select2">
                <?php foreach ($tahun as $row) { ?>
                    <option value="<?= $row->tahun_m ?>" <?= $row->tahun_m == $setting['tahunaktif'] ? 'selected' : '' ?>>
                        <?= $row->tahun_m ?>
                    </option>
                <?php } ?>
            </select>
