<div class="col-md-12">
    ...
    <div class="alert alert-success alert-dismissible">
        <h5><i class="icon fas fa-info"></i> Total Pemasukan Kas yatim</h5>
...
<div class="col-md-12">
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title">Data Kas yatim</h3>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button type="button" class="btn btn-warning btn-xs" data-toggle="modal"
                                data-target="#modal-edit<?= $value['id_kas_yatim'] ?>"><i
                                    class=" fas fa-pencil-alt"></i>
                            </button>
                            <button type="button" class="btn btn-danger btn-xs" data-toggle="modal"
                                data-target="#modal-delete<?= $value['id_kas_yatim'] ?>"><i class=" fas fa-trash"></i>
                            </button>
                        </td>
                    </tr>
                    <?php } ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('KasYatim/InsertKasMasuk') ?>
...
<div class="modal fade" id="modal-edit<?= $value['id_kas_yatim'] ?>">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('KasYatim/UpdateKasMasuk/' . $value['id_kas_yatim']) ?>
                <div class="form-group">
                    <label for="">Tanggal</label>
                ...
                <div class="form-group">
                    <label for="">Jumlah(Rp.)</label>
                    <input type="number" min="0" name="kas_masuk" value="<?= $value['kas_masuk'] ?>"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <a href="<?= base_url('KasYatim/DeleteKasMasuk/' . $value['id_kas_yatim']) ?>"
