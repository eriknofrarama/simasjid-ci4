<div class="col-md-4">
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title">Kirim Donasi Anda Ke Rekening Dibawah ini</h3>
            <!-- /.card-tools -->
        </div>
        <!-- /.card-header -->
        <div class="card-body">
...
<div class="col-md-8">
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title">Konfirmasi Bukti Donasi</h3>
            <!-- /.card-tools -->
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <select name="jenis_donasi" class="form-control">
                            ...
                            <option value="Sosial">Yatim</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <label>No Rekening Pegirim</label>
